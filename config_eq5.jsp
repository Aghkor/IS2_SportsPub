<%-- 
    Document   : config_eq5
    Created on : 5/03/2019, 12:03:41 PM
    Author     : PERSONAL
--%>
              ...
              <ul class="sidebar-menu" id="nav-accordion">
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">
						  ...
						  <li class="active"><a  href="config_eq5.html">configurar equipo futbol 5 </a></li>
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="get">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input class="form-control" id="numero_integrantes" type="text" >
                              </div>
                          </div>
                        <a class="btn btn-theme  " href="config_perfilusuario.html" type="s">Guardar cambios</a>
		            <hr>
                          </div>
                      </form>
                  </div>
                              ...
                              <div class="form-group ">
                                  ...
                                  <div class="col-lg-10">
                                      <input type="text" class="form-control" id="futbol5_1" disabled>
									   ...
									   <a class="btn btn-theme  " href="config_perfilusuario.html" type="s">Eliminar del equipo </a>  
                                  </div>
                              </div>
                              <div class="form-group">
