<%-- 
    Document   : perfil
    Created on : 5/03/2019, 11:53:14 AM
    Author     : PERSONAL
--%>
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post">
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" id="nombre" type="text" disabled>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Apellido </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" id="Apellido" type="text" disabled>
                               </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Correo Electronico </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" id="email" type="text" disabled>
                              </div>
                          </div>
    ...
    <script>
        $(function()){
            $("#button").click(function(){
                ...
                var text0 = $("#nombre").val();
                var text1 = $("#apellido").val();
                var text2=  $("#email").val();
                var text3 = $("#edad").val();
                var text4 = $("#genero").val();
                var text5 = $("#celular").val();
                
                $.ajax({ url:text0, dataType: "text", success:function(data){
                        $(".text").html("<pre>"+data+"</prev>");
