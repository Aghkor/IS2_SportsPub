<%-- 
    ...
    Created on : 5/03/2019, 12:01:20 PM
    Author     : PERSONAL
--%>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>Usuario </b></a>
            <!--logo end-->
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="get">
						  ...
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Contraseña Vieja</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" id="contraseñan" type="text" >
                              </div>
                          </div>
          			...
          			<div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> EQUIPOS FUTBOL 5 </h4>
                          <form class="form-horizontal tasi-form" method="get">
							  ...
							  <button class="btn btn-theme btn-block" href="index.html" type="submit"><i class="fa fa-lock"></i> SALIR DEL EQUIPO  </button>
		            <hr>
                          </form>
          			</div>
					<div class="form-panel">
