<%-- 
    Document   : perfilequipo5
    Created on : 5/03/2019, 11:55:59 AM
    Author     : PERSONAL
--%>
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="perfilequipo5.html">Perfil Equipo futbol 5 </a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Perfil Futbol 5</h3>
          	...
          	<div class="row mt">
				 ...
				 <label class="col-sm-2 col-sm-2 control-label">Valorizacion del jugador</label>
				  <div class="valoracion">
                        ...
                        <a class="btn btn-theme  " href="config_eq5.html">Configuracion del equipo futbol 5</a>
		            <hr>
                            </form>
                          </div>                
                  </div>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="get">
                        ...
                        <button class="btn btn-theme btn-block" href="index.html" type="submit"><i class="fa fa-lock"></i> CONFIGURAR </button>
		            <hr>
                          </div>
                      </form>
                  </div>
