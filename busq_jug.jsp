<%-- 
    Document   : busq_jug
    Created on : 5/03/2019, 12:04:30 PM
    Author     : PERSONAL
--%>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="get">
						 ...
						 <a class="btn btn-theme  " href="config_perfilusuario.html">Buscar jugador</a>
                      ...
                      <!-- SERVER STATUS PANELS -->
                      	<div class="col-md-4 col-sm-4 mb">
							...
							<div class="white-panel pn">
								...
								<a class="btn btn-theme " href="detalles_evento.html">Contactar jugador</a>
							</div>
						</div>
						...
						<div class="col-md-4 col-sm-4 mb">
							...
							<div class="white-panel pn">
								...
								<a class="btn btn-theme " href="detalles_evento.html">Contactar Perfil</a>
							</div>
						</div>><!-- /col-md-4 -->
