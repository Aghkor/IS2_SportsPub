...
<html lang="en">
  ...
  <section id="container" >
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="perfilequipo5.jsp">Perfil Equipo futbol 5 </a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel" id="contendor">
					  ...
					  <div class="form-group">
                        ...
                        <a class="btn btn-theme btn-block  " href="config_eq5.jsp">Configuracion del equipo futbol 5</a>
		            <hr>
                          </div>
                      </form>
                  </div>
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          			<div class="form-panel" id="contenedor2">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> INTEGRANTES  FUTBOL 5 </h4>
                          <form class="form-horizontal tasi-form" method="get">
							  ...
							  <div class="form-group ">
                                  ...
                                  <div class="col-lg-10">
                                      <input type="text" class="form-control" id="futbol5_3" disabled>
                                  </div>
                              </div>
							  <div class="form-group ">
                                  <label class="col-sm-2 control-label col-lg-2" >Integrante 4 </label>
                                  <div class="col-lg-10">
                                      <input type="text" class="form-control" id="futbol5_4" disabled>
                                  </div>
                              </div>
							  <div class="form-group ">
                                  <label class="col-sm-2 control-label col-lg-2" >Integrante 5 </label>
                                  <div class="col-lg-10">
                                      <input type="text" class="form-control" id="futbol5_5" disabled>
                                  </div>
                              </div>
     ...
     <script src="perfilequipo5_jvs.js"></script>
